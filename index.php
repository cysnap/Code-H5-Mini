...
<div class="post-block">
	...
	<div class="post">
		<div class="post-title">
			...
			<?php else: ?>
			<h2><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title(); ?>" target="_blank"><?php the_title(); ?></a><?php video_tag(); ?><?php $diff = strtotime(date('Y-m-d H:i:s'))-strtotime(get_the_time('Y-m-d H:i:s')); if ($diff <= -25100){echo '<img src="http://imgcdn.sinaapp.com/new-code-h/images/new-icon.gif" />';} ?></h2>
			<?php endif; ?>
