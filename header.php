...
<head>
	...
	<script type="text/javascript" src="<?php echo get_stylesheet_directory_uri(); ?>/js/jquery-2.0.3.min.js"></script>
...
<header>
	<div class="nova-l-h">
			...
			<div class="nova-r">
			<?php if(!is_home()) : dynamic_sidebar( '468x60-Ads' ); else : show_ads(8); endif; ?>
			</div>
